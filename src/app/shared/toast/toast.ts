...
@Component({
  ...
  styles: [`
    ...
    .toast { display:flex; align-items:flex-start; gap:10px; padding:12px 14px; border-radius:10px; font-size:13px; line-height:1.4; background:#0f0f0f; border:1px solid #1e1e1e; box-shadow:0 12px 32px rgba(0,0,0,0.6); animation:toast-in 0.2s ease-out; }
    @keyframes toast-in { from { opacity:0; transform:translateY(8px); } to { opacity:1; transform:translateY(0); } }
    .toast.error { border-color:rgba(224,85,85,0.35); color:#f0a0a0; }
    .toast.success { border-color:rgba(212,160,23,0.35); color:#D4A017; }
    .toast.info { border-color:#2a2a2a; color:#e8e8e8; }
