    ...
    <div [style]="bg" style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:16px;">
      <div style="width:100%;max-width:380px;">
        ...
        <div style="background:#0f0f0f;border:1px solid rgba(212,160,23,0.12);border-radius:20px;padding:28px;box-shadow:0 32px 64px rgba(0,0,0,0.7);">
          <h2 style="color:#e8e8e8;font-size:18px;font-weight:600;margin:0 0 20px 0;">Iniciar sesión</h2>
          ...
          <form (ngSubmit)="submit()" #form="ngForm">
            <div style="margin-bottom:14px;">
              ...
              <input class="auth-input" type="text" [(ngModel)]="username" name="username" required autocomplete="username" placeholder="tu_usuario" />
            </div>
            <div style="margin-bottom:22px;">
              ...
              <input class="auth-input" type="password" [(ngModel)]="password" name="password" required autocomplete="current-password" placeholder="••••••••" />
            </div>
        ...
        <p style="text-align:center;font-size:13px;color:#444;margin-top:20px;">
          ¿No tienes cuenta?
          <a routerLink="/register" style="color:#D4A017;text-decoration:none;font-weight:500;margin-left:4px;">Regístrate</a>
        </p>
      </div>
    </div>
  `,
